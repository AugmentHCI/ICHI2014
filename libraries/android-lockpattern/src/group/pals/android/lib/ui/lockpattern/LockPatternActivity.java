...
public class LockPatternActivity extends Activity {
     ...
     * {@link LockPatternUtils#patternToSha1(java.util.List)}.</li>
     * </ul>
     * 
     * @since v2 beta
     */
     ...
     * will call it inside {@link group.pals.android.lib.ui.lockpattern.LockPatternActivity} .</li>
     * </ul>
     */
     ...
     * since the library will call it inside {@link group.pals.android.lib.ui.lockpattern.LockPatternActivity} .</li>
     * <li>{@link group.pals.android.lib.ui.lockpattern.LockPatternActivity} will finish with
    ...
    private void loadSettings() {
        ...
        if (metaData != null
                && metaData
                        .containsKey(Settings.Display.METADATA_MIN_WIRED_DOTS))
        ...
        if (metaData != null
                && metaData.containsKey(Settings.Display.METADATA_MAX_RETRIES))
        ...
        if (metaData != null
                && metaData
                        .containsKey(Settings.Security.METADATA_AUTO_SAVE_PATTERN))
            mAutoSave = metaData
        ...
        if (metaData != null
                && metaData
                        .containsKey(Settings.Display.METADATA_CAPTCHA_WIRED_DOTS))
        ...
        if (metaData != null
                && metaData.containsKey(Settings.Display.METADATA_STEALTH_MODE))
        ...
        if (metaData != null
                && metaData
                        .containsKey(Settings.Security.METADATA_ENCRYPTER_CLASS))
        ...
        if (getIntent().hasExtra(EXTRA_PATTERN)) {
            ...
            new LoadingDialog<Void, Void, Boolean>(this, false) {
                ...
                protected void onPostExecute(Boolean result) {
                    ...
                    if (result) {
                        mTextInfo
                                .setText(R.string.alp_msg_your_new_unlock_pattern);
                        mBtnConfirm.setEnabled(true);
                    } else {
                        mTextInfo
